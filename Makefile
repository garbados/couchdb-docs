...
# share/doc/Makefile.  Generated from Makefile.in by configure.
...
am__relativize = \
  ...
  reldir="$$dir2"
ACLOCAL = ${SHELL} /Users/deus/code/couchdb/build-aux/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /Users/deus/code/couchdb/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/deus/code/couchdb/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/deus/code/couchdb/build-aux/missing automake-1.13
AWK = awk
CC = gcc
...
ICU_CPPFLAGS =   -DU_HAVE_ATOMIC=0   -I/usr/local/Cellar/icu4c/52.1/include 
...
JS_CFLAGS = -DXP_UNIX -I/usr/local/Cellar/spidermonkey/1.8.5/include/js -I/usr/local/Cellar/nspr/4.10/include/nspr 
JS_LIBS = -lmozjs185 -lm -L/usr/local/Cellar/spidermonkey/1.8.5/lib -L/usr/local/Cellar/nspr/4.10/lib -lmozjs185 -lplds4 -lplc4 -lnspr4 
JS_LIB_BINARY = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/deus/code/couchdb/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = Apache CouchDB 1.5.0+build.d3d1966
PACKAGE_TARNAME = apache-couchdb
PACKAGE_URL = 
PACKAGE_VERSION = 1.5.0+build.d3d1966
PATH_SEPARATOR = :
...
SNAPPY_PATCHLEVEL = 5
STRIP = strip
VERSION = 1.5.0+build.d3d1966
abs_builddir = /Users/deus/code/couchdb/share/doc
abs_srcdir = /Users/deus/code/couchdb/share/doc
abs_top_builddir = /Users/deus/code/couchdb
abs_top_srcdir = /Users/deus/code/couchdb
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
initdir = 
install_sh = ${SHELL} /Users/deus/code/couchdb/build-aux/install-sh
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am  $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign share/doc/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign share/doc/Makefile
.PRECIOUS: Makefile
